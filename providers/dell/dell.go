...
func (d *dell) GetInventory(ctx context.Context, options ...actions.Option) (*model.Device, error) {
...
func (d *dell) GetInventoryOEM(ctx context.Context, _ *model.Device, options *model.UpdateOptions) error {
